import {
  ...
  import { getProviderAction, newProviderAction, updateProviderAction } from "../../../features/actions/providerAction";
import { useNavigate, useParams } from "react-router-dom";
  ...
  const UpdateProvider = () => {
    ...
    const findProvValues = getProviders.result?.find(el => el.providerId === Number(id))
    ...
    const initialValues = {
      ...
      providerTaxonomySpeciality: findProvValues?.providerTaxonomySpeciality || "",
    ...
    const { handleBlur, handleChange, handleSubmit, values, setFieldValue, setValues } =
      useFormik({
