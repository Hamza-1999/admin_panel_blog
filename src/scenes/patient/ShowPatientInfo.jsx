...
//       <Box width={"100%"} padding={"20px"}>
//         <Header title="Patient Details" subtitle="" />
//         <div style={{ background: "lightgray" ,height:'200px',width:'400px'}}>
//           <Grid
//             container
//             width="100%"
//             marginTop={"20px"}
      ...
      <Box width={"100%"}  padding={"20px"}>
        ...
        {/* <div style={{ background: "lightgray" ,height:'200px',width:'400px'}}> */}
          ...
          >
            {/* <Grid item xs={12} justifyContent={"space-between"}>
              <Stack flexDirection={"row"} alignItems={"center"}>
                <Paper sx={{ paddingTop: '30px 2px 2px 2px', background: '#F9F9F9', borderRadius: '10px',height:'13rem',width:'11rem',marginTop:'-60px',boxShadow: '4px 0px 9px 0px rgba(0, 0, 0, 0.11)'}}>
                ...
                >
                  <img src='/public/assets/stones.jpg'/>
                ...
                <Typography
                  ...
                  fontWeight={"800"}
                >
                 <span style={{fontSize:'22px',marginLeft:'15px',marginTop:'20px'}}>
                  {`${selectedPatient?.firstName} ${selectedPatient?.lastName}`}{" "}</span><br/>
                 
                  <span style={{fontSize:'18px',fontWeight:'600',marginLeft:'27px',color:'black'}}>
                  ( #{selectedPatient?.accountNo})
                  </span>
                </Typography>
                </Paper>
...
<Grid item xs={12} justifyContent={"space-between"}>
  <Stack flexDirection={"row"} alignItems={"center"}>
    ...
    {/* Your first Paper component */}
    <Paper sx={{ paddingTop: '30px 2px 2px 2px', background: '#F9F9F9', borderRadius: '10px', height:'13rem', width:'14rem', marginTop:'-60px', boxShadow: '4px 0px 9px 0px rgba(0, 0, 0, 0.11)',marginLeft:'10px'}}>
      <Avatar
        sx={{
          width: 120,
          height: 100,
    ...
    <Box sx={{ backgroundImage: 'url("/public/assets/your-background-image.jpg")', height: '10rem', width: '100%', boxShadow: '4px 0px 9px 0px rgba(0, 0, 0, 0.11)',background: 'linear-gradient(180deg, #ABE1FF 0%, #5C9FDD 100%)',marginBottom:'12px',zIndex:'1' }}>
  ...
  <Box sx={{display:"flex", flexWrap:'wrap'}}>
    ...
    <Paper sx={{background:'white',borderRadius:'8px',width:'125px',height:'50px',marginLeft:'30px'}}>
    <Grid item xs={12} sm={4} >
...
fontStyle: 'normal',
fontWeight: '500',
lineHeight: 'normal',marginTop:'10px'}}variant="h5" component={"h3"}>
                PhoneNo
              </Typography>
              <Typography>{selectedPatient?.cellPhone}</Typography>
            </Grid>
