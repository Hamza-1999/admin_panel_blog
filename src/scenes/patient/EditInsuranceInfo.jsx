...
const EditInsuranceInfo = ({ handleClose }) => {
  ...
  const findInitialInsurance = getAllPatients.result?.find(
    (el) => el.accountNo === accountNo
  );
  console.log(findInitialInsurance, "initial values");
  // initial formik values
  const initialValues = {
    // Insured Information Data
    insuredFirstName: findInitialInsurance?.firstName || "",
    insuredLastName: findInitialInsurance?.lastName || "",
    insuredDateOfBirth: findInitialInsurance?.dateOfBirth
      ? dayjs(findInitialInsurance?.dateOfBirth)
      : null,
